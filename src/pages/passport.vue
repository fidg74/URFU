    ...
    <b-container class="passport-page">
        ...
        <template v-if="project">
            ...
            <b-row class="mt-4">
                ...
                <b-col>
                    <div v-pin-aside class="right-sidebar">
                        ...
                        <b-button variant="success" class="show-changes mb-3" @click="showHistory">История правок</b-button>
                        ...
                        <div class="project-status__wrap project-status__progress">
